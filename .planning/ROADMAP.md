...
- [x] **Phase 195: Hunt System Complete Rework (Two-Screen Catalog, Pull Size & Monster Variants) & PvP Arena Loading Fix** - UI autêntica de caçadas em duas telas idêntica às referências visuais com grid de 4 colunas, abas superiores (Caçadas, Treino, Quests, Arena, Bosses), busca e favoritos; tela de setup com lore, recorde e seletor de dificuldade por tamanho de pull (Cauteloso [2-3], Ousado [4], Agressivo [5-6]); variações dinâmicas de monstros por pull (Elfs com Scout e Arcanist, Rats com Cave Rat, Cyclops com Smith, Dragons com Dragon Lord); tabela agregada de loot com checkboxes PEGAR/VENDER e auto-loot permanente de gold coin; e resolução definitiva do travamento de loading na Arena PvP.
