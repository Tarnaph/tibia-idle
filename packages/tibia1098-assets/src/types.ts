...
export interface AppearanceFrameGroup extends AppearanceDimensions {
  frameGroupType: number;
  spriteIds: number[];
}
...
export interface Tibia1098AssetManifest {
  schemaVersion: 1;
  format: {
...
export interface ExtractionResult {
  manifest: Tibia1098AssetManifest;
