...
const historicalContext = 'Preço de venda canônico oficial do Tibia 10.98 / 11 (NPC de compra de equipamentos, utilitários, comida ou creature products).';
...
export const webPriceFallbacks = new Map<number, WebItemSellOffer>([
  ...
  [2145, offer(300, 'Small Diamond')],
  [2177, offer(500, 'Life Crystal')],
  [2187, offer(3000, 'Wand of Inferno')],
  [2387, offer(260, 'Double Axe')],
  [2397, offer(51, 'Longsword')],
  [2409, offer(900, 'Serpent Sword')],
  [2413, offer(500, 'Broadsword')],
  [2434, offer(2000, 'Dragon Hammer')],
  [2455, offer(160, 'Crossbow')],
  [2457, offer(293, 'Steel Helmet')],
  [2509, offer(80, 'Steel Shield')],
  [2516, offer(4000, 'Dragon Shield')],
  [2546, offer(10, 'Burst Arrow')],
  [2647, offer(115, 'Plate Legs')],
  [2672, offer(25, 'Dragon Ham')],
  [5877, offer(100, 'Green Dragon Leather')],
  [5920, offer(100, 'Green Dragon Scale')],
  [7430, offer(3000, 'Dragonbone Staff')],
  [7588, offer(100, 'Strong Health Potion')],
  [12413, offer(100, "Dragon's Tail")],
