...
export const initialHunts: HuntDefinition[] = [
  ...
  {
    id: 'corym-mine', name: 'Corym Mine', displayName: 'Minas dos Coryms',
    description: 'Túneis subterrâneos escavados pelas três castas de homens-rato.', shortDescription: 'Coryms trabalham e defendem ferozmente suas minas.',
    recommendedLevel: 40, minimumLevel: 1, monsters: ['corym-vanguard', 'corym-skirmisher', 'corym-charlatan'], rewardProfile: 'xp', status: 'available',
    roomDefinitions: rooms('corym-mine'), environment: { regionId: 'corym-mine', label: 'Corym Mines', source: 'realmap11-otbm' },
    waves: waves('corym-vanguard', [1, 2, 2, 3, 3, 4, 4, 5, 5, 0], 'Corym Overlord', 2),
  },
  {
    id: 'giant-spider-lair', name: 'Giant Spider Lair', displayName: 'Covil da Aranha Gigante',
    description: 'Caverna sombria coberta por teias densas e aracnídeos letais.', shortDescription: 'Teias grossas escondem predadores colossais e peçonhentos.',
    recommendedLevel: 50, minimumLevel: 1, monsters: ['giant-spider', 'tarantula'], rewardProfile: 'xp', status: 'available',
    roomDefinitions: rooms('giant-spider-lair'), environment: { regionId: 'giant-spider-lair', label: 'Giant Spider Caves', source: 'realmap11-otbm' },
    waves: waves('giant-spider', [1, 1, 2, 2, 2, 3, 3, 3, 4, 0], 'The Old Widow', 2),
  },
  {
    id: 'hero-cave', name: 'Hero Cave', displayName: 'Santuário dos Heróis',
    description: 'Fortaleza subterrânea de cavaleiros renegados e guerreiros lendários.', shortDescription: 'Cavaleiros e escudeiros vigiam tesouros ancestrais.',
    recommendedLevel: 70, minimumLevel: 1, monsters: ['hero', 'renegade-knight', 'vicious-squire'], rewardProfile: 'xp', status: 'available',
    roomDefinitions: rooms('hero-cave'), environment: { regionId: 'hero-cave', label: 'Hero Fortress', source: 'realmap11-otbm' },
    waves: waves('hero', [1, 1, 2, 2, 2, 3, 3, 3, 4, 0], 'Grandmaster Hero', 2),
  },
  {
    id: 'hydra-lair', name: 'Hydra Lair', displayName: 'Pântano das Hidras',
    description: 'Montanhas e pântanos úmidos infestados de serpentes marinhas de múltiplas cabeças.', shortDescription: 'Criaturas regenerativas e rastejantes da selva profunda.',
    recommendedLevel: 80, minimumLevel: 1, monsters: ['hydra', 'bog-raider'], rewardProfile: 'xp', status: 'available',
    roomDefinitions: rooms('hydra-lair'), environment: { regionId: 'hydra-lair', label: 'Tiquanda Hydras', source: 'realmap11-otbm' },
    waves: waves('hydra', [1, 1, 2, 2, 2, 3, 3, 3, 4, 0], 'The Many', 2),
  },
  {
